<template>
  <div id="about-festival" class="bg-white rounded-xl shadow-[0_8px_40px_rgba(0,0,0,0.08)] w-full max-w-screen-sm md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl px-8 md:px-12 py-14">
    ...
    <p class="text-lg font-roboto font-normal text-neutral-500 leading-relaxed mb-4">
      Explore what <span class="font-bold text-trim-teal">holism</span> is about and how the festival traces its origins to a century of <span class="font-bold text-trim-purple">transformative thinking</span>.
    </p>
    <a href="#programme" class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-condensed font-bold uppercase tracking-wider bg-trim-purple/10 text-trim-purple transition hover:opacity-80 cursor-pointer mb-12">
      ...
      Jump to: The Programme
    </a>

    <!-- Top 2-column: Smuts feature image + content -->
    <div class="flex flex-col lg:flex-row items-stretch gap-0 mb-14 rounded-xl overflow-hidden">
      <!-- Left column: Full-width feature image -->
      <div class="relative lg:w-1/2 shrink-0">
        <img src="/images/smuts.jpg" alt="Jan Christian Smuts" class="w-full h-72 lg:h-full object-cover object-top" />
        <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
        <div class="absolute bottom-0 left-0 right-0 p-6">
          <h3 class="text-2xl font-condensed font-bold uppercase tracking-wide text-white mb-1">Jan Christian Smuts</h3>
          <p class="text-sm font-condensed font-normal uppercase tracking-[0.2em] text-white/70">1870–1950</p>
        </div>
      </div>

      <!-- Right column: Text content -->
      <div class="flex-1 bg-bg-default p-8 lg:p-10 flex flex-col gap-6">
        <h3 class="text-2xl lg:text-3xl font-condensed font-bold uppercase tracking-wide text-trim-purple">
          Saving the Soul of Civilisation
        </h3>
        <p class="text-xl lg:text-2xl font-condensed font-normal uppercase leading-snug text-neutral-500 tracking-wide">
        ...
        <div class="flex">
          ...
          <div class="pl-6 flex flex-col gap-4">
            <p class="text-lg font-roboto font-normal text-neutral-600 leading-relaxed">
            ...
            <p class="text-base font-roboto font-normal text-neutral-500 leading-relaxed italic">
              In a time when our world once again feels fragmented and uncertain, this insight speaks with renewed relevance.
            </p>
          </div>
        </div>
        <p class="text-lg font-roboto font-normal text-neutral-500 leading-relaxed">
        ...
        <p class="text-base font-roboto font-normal text-neutral-500 leading-relaxed">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div class="bg-bg-default rounded-xl p-8 flex flex-col">
        ...
        <h3 class="text-xl font-condensed font-bold uppercase tracking-wide text-trim-teal mb-3">
          What is Holos.Earth?
        </h3>
        <p class="text-base font-roboto font-normal text-neutral-500 leading-relaxed">
      ...
      <div class="bg-bg-default rounded-xl p-8 flex flex-col">
        <div class="w-12 h-12 rounded-full bg-trim-green flex items-center justify-center mb-5">
          <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c1.5 0 3-.3 4.3-.9" />
            <path d="M17 8c-3 0-5 2.5-5 5.5S14 19 17 19s5-2.5 5-5.5S20 8 17 8z" />
          </svg>
        </div>
        <h3 class="text-xl font-condensed font-bold uppercase tracking-wide text-trim-green mb-3">
          Living a Holistic Life
        </h3>
        <p class="text-base font-roboto font-normal text-neutral-500 leading-relaxed">
          Whilst the prevailing mechanistic and materialistic worldview has brought numerous advantages, it is now recognised as having separated us from natural organic life processes. Evaluating the cost of that separation in terms of human life and planetary sustainability is an essential aspect of creating a new compass to navigate by.
        </p>
      </div>

      <!-- Restoring Our Connection -->
      <div class="bg-bg-default rounded-xl p-8 flex flex-col">
        <div class="w-12 h-12 rounded-full bg-trim-purple flex items-center justify-center mb-5">
          <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <h3 class="text-xl font-condensed font-bold uppercase tracking-wide text-trim-purple mb-3">
          Restoring Our Connection
        </h3>
        <p class="text-base font-roboto font-normal text-neutral-500 leading-relaxed">
