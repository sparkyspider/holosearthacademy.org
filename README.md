...
- **Name** (required)
- **Email** (required)
- **Festival Phase II – Specialist Presentations** (optional checkbox)
- **Festival Phase III – South African Pilgrimage** (optional checkbox)
- **Holistic Systems Practice Training** (optional checkbox)
- **Claudius' Book Release** (optional checkbox)
...
The `source` field is `holosearthacademy.org` for modal registrations and `holosearthacademy.org-newsletter` for the inline newsletter form (both routes write to the same table).
...
| `phase_2` | `BOOLEAN` | Festival Phase II – Specialist Presentations. Default `false` |
| `cape_town` | `BOOLEAN` | Festival Phase III – South African Pilgrimage. Default `false` |
| `hsp_training` | `BOOLEAN` | Holistic Systems Practice Training. Default `false` |
| `book_release` | `BOOLEAN` | Claudius' Book Release. Default `false` |
| `source` | `TEXT` | `holosearthacademy.org` or `holosearthacademy.org-newsletter` |
